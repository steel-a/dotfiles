...
export TIMEZONE="America/Sao_Paulo"
  ...
  #########################
  #runuser -l $USER -c 'git clone git@github.com:steel-a/dotfiles_old.git ~/.config/dotfiles && chmod +x ~/.config/dotfiles/bin/*.sh && ~/.config/dotfiles/bin/launch-dotfiles.sh' \
